<?php  //[STAMP] 33e0d7ad16a1a2f3d5aa19ea480f2541
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::saveCookie()
     */
    public function saveCookie($cookieName) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('saveCookie', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::useSavedCookie()
     */
    public function useSavedCookie($cookieName) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('useSavedCookie', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::forgotCookie()
     */
    public function forgotCookie($cookieName) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('forgotCookie', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::forgotAll()
     */
    public function forgotAll() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('forgotAll', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::amHttpAuthenticatedAs()
     */
    public function amHttpAuthenticatedAs($account) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amHttpAuthenticatedAs', func_get_args()));
    }
}
